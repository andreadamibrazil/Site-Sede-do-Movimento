...
function LoginContent() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") ?? "/pauta/sede";
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="w-8 h-8 border-2 border-[#6A00FF] border-t-transparent rounded-full animate-spin" /></div>}>
      <LoginContent />
    </Suspense>
  );
}
